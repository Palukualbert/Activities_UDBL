                ...
                <div class="row align-items-center">
                    <div class="col-lg-7" data-aos="zoom-out" data-aos-delay="100">
                        <div class="hero-content">
                            <h1>Faire la difference</h1>
                            <p>Solidarité - Innovation - Travail</p>
                            <div class="cta-buttons">
                                <a href="#" class="btn-primary">Commencer votre voyage</a>
                                <a href="#" class="btn-secondary">Decouvrir les programmes</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row mb-5">
                <div class="col-lg-6 pe-lg-5" data-aos="fade-right" data-aos-delay="200">
                    <h2 class="display-6 fw-bold mb-4">Donner du pouvoir aux esprits,  <span>Façonner l'avenir</span></h2>
                    ...
                    <div class="d-flex align-items-center mt-4 signature-block">
                        ...
                        <div class="ms-3">
                            <p class="mb-0 fw-bold">Jean-Luc Vande Kerkhove </p>
                            <p class="mb-0 text-muted">Recruteur</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mission-vision-row g-4">
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="value-card h-100">
                        ...
                        <h3>Notre Mission</h3>
                        <p>Former des ingénieurs en informatique compétents, intègrer la dimension humaine et chrétienne, encourager l’entrepreneuriat, propose des formations continues pour professionnels et offre des services informatiques via son centre de recherche CREDIA.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="value-card h-100">
                        ...
                        <h3>Nos Valeurs</h3>
                        <p> La devise de l'UDBL est « Solidarité – Innovation – Travail ». Cette devise incarne les 3 valeurs essentielles de l’Université qui sont : Solidarité</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                <ul class="program-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
                    <li data-filter="*" class="filter-active">Tous Les Programmes</li>
                    <li data-filter=".filter-bachelor">Licence</li>
                    <li data-filter=".filter-master">Master</li>
